    ...
    pub async fn get_price(&self, token_address: &Address) -> Result<U256> {
        ...
        for pool in pools {
            ...
            if let Some(other_eth_price) = other_token.get_eth_price() {
                ...
                let scaled_other_reserve = U256::from(other_reserve.to::<u128>()).checked_mul(U256::from(decimal_adjustment))
                ...
                let price_u256 = numerator.checked_div(U256::from(token_reserve.to::<u128>()))
