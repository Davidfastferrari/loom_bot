...
pub struct BlockchainState {
    // Add fields and methods relevant to blockchain state management
}

// Add any other shared types, traits, or utilities needed by both crates

// Ensure block message size is handled correctly to avoid runtime errors
